...
class AllProductsSection extends Component {
  ...
  renderFailureView = () => {
    ;<div className="failure-container">
      ...
      <p className="describe">Please try again.</p>
    </div>
  }
  ...
  updateRating = status => {
    this.setState({activeRating: status})
  }

  updateParameters = () => {
    this.setState({activeCategory: '', activeRating: '', titleSearch: ''})
  }
  ...
  render() {
    const {isLoading, activeCategory, activeRating} = this.state
